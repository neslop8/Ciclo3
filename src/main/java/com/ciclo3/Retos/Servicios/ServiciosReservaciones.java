...
public class ServiciosReservaciones {
    ...
    public Reservaciones save(Reservaciones reservaciones) {
        if (reservaciones.getIdReservation() == null) {
            ...
            Optional<Reservaciones> evt = metodosCrud.getReservation(reservaciones.getIdReservation());
            if (evt.isEmpty()) {
                return metodosCrud.save(reservaciones);
            } else {
        ...
        if (reservaciones.getIdReservation() != null) {
            ...
            if (!evt.isEmpty()) {
                if (reservaciones.getStartDate() != null) {
                    evt.get().setStartDate(reservaciones.getStartDate());
                }
                if (reservaciones.getDevolutionDate() != null) {
                    evt.get().setDevolutionDate(reservaciones.getDevolutionDate());
                }
                if (reservaciones.getStatus() != null) {
                    evt.get().setStatus(reservaciones.getStatus());
                }
