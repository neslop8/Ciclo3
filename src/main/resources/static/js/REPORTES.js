function reporteStatus() {
    $.ajax({
        url: "http://129.151.121.112:8080/api/Reservation/report-status",
        type: "GET",
        datatype: "JSON",
...
function reporteFechas() {
    ...
    $.ajax({
        url: "http://129.151.121.112:8080/api/Reservation/report-dates/" + fechaInicial + "/" + fechaFinal,
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
...
function reporteTop() {
    $.ajax({
        url: "http://129.151.121.112:8080/api/Reservation/report-clients",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
